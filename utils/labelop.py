...
def extract_signal(input_file_path, output_path, basecall_group, basecall_subgroup, normalization, max_length):
    """
    Extract the signal and label from a single fast5 file into Multiple Segments
    Args:
        input_file_path: path of a fast5 file.
...
def extract_fast5_raw(input_file_path, output_prefix, normalization, max_length, signal_stride, endfix):
